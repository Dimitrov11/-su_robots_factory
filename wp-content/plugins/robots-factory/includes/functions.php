...
function robots_plugin_enqueue_assets() {
    ...
    wp_enqueue_script( 'robots-assets-plugin', ROBOTS_FACTORY_PLUGIN_ASSETS_DIR . '/js/scripts.js', array( 'jquery' ), '1.0', $args );
...
/** Function that handles AJAX call and add a like to the post */
...
function robots_factory_options_page() {
    add_menu_page( 
        'Robots Options',
        'Robots Options',
        'manage_options',
...
add_action( 'admin_menu', 'robots_factory_options_page' );
