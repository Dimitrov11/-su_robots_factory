    <?php
        ...
        if ( ! empty( $_POST['robots_save'] ) && $_POST['robots_save'] == 1 ) {
            ...
            if ( ! empty( $_POST['robots_homepage_post_number'] ) ) {
                $robots_homepage_post_per_page = esc_attr( $_POST['robots_homepage_post_number'] );
                update_option( 'robots_homepage_post_per_page', $robots_homepage_post_per_page, false);
            }
