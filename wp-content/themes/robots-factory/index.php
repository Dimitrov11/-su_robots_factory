        ...
        <section id="product" class="product">
            <div class="container section-bg">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="porduct-box">
                            <img class="img-responsive" src="<?php echo ROBOTS_FACTORY_ASSETS_URL; ?>images/product-2.jpg" alt="product">
                            <h3 class="product-title">Sports robot</h3>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="porduct-box">
                            <img class="img-responsive" src="<?php echo ROBOTS_FACTORY_ASSETS_URL; ?>images/product-3.jpg" alt="product">
