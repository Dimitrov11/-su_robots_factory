...
function enqueue_robots_theme_assets() {
    ...
    // Theme Google Fonts
    wp_enqueue_style('font-roboto', 'https://fonts.googleapis.com/css?family=Roboto:400,300,500,700&display=swap', false );
    wp_enqueue_style('font-oswald', 'https://fonts.googleapis.com/css?family=Oswald:400,300,700', false );
